...
| refs | 104 | explicit implementation owner in refs/disassembly evidence |
| cfg | 103 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
