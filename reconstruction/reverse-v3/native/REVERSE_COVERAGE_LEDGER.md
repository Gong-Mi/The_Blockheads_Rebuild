...
| refs | 153 | explicit implementation owner in refs/disassembly evidence |
| cfg | 152 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
| semantics | 39 | explicit reviewed method records and their stated limits |
| implemented | 39 | explicit source/test/evidence records; not gameplay integration |
