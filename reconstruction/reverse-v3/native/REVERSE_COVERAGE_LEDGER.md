...
| refs | 69 | explicit implementation owner in refs/disassembly evidence |
| cfg | 68 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
| semantics | 36 | explicit reviewed method records and their stated limits |
| implemented | 36 | explicit source/test/evidence records; not gameplay integration |
