...
| refs | 100 | explicit implementation owner in refs/disassembly evidence |
| cfg | 99 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
