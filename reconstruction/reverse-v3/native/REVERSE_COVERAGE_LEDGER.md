...
| refs | 152 | explicit implementation owner in refs/disassembly evidence |
| cfg | 151 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
| semantics | 38 | explicit reviewed method records and their stated limits |
| implemented | 38 | explicit source/test/evidence records; not gameplay integration |
