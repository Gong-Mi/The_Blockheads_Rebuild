...
| refs | 154 | explicit implementation owner in refs/disassembly evidence |
| cfg | 153 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
| semantics | 40 | explicit reviewed method records and their stated limits |
| implemented | 40 | explicit source/test/evidence records; not gameplay integration |
