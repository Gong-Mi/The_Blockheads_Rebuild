...
| refs | 112 | explicit implementation owner in refs/disassembly evidence |
| cfg | 111 | explicit IMP owner in CFG statistics or bounded disassembly; not a completeness claim |
