#!/usr/bin/env python3
"""Generate the batch-2m pairing table mechanically from annotated listings
...
BODIES = {
 'InteractionObject': ('disasm_interactionobject_getsavedict.txt', 0x005F50B8, 0x005F58C0),
