#!/usr/bin/env python3
"""Generate the batch-2k pairing table mechanically from annotated listings
...
BODIES = {
 'Boat':           ('disasm_boat_getsavedict.txt', 0x0096C238, 0x0096C674),
 'ArtificialLight': ('disasm_artificiallight_getsavedict.txt', 0x00A942D4, 0x00A947AC),
 'DropBear':    ('disasm_dropbear_getsavedict.txt',    0x0079DDC0, 0x0079E2B8),
}
