#!/usr/bin/env python3
"""Generate the batch-2j pairing table mechanically from annotated listings
...
BODIES = {
 'TradingPost': ('disasm_tradingpost_getsavedict.txt', 0x005E6B08, 0x005E7024),
 'Torch':       ('disasm_torch_getsavedict.txt',       0x004B65B8, 0x004B69E0),
 'FireObject':  ('disasm_fireobject_getsavedict.txt',  0x0067501C, 0x006753EC),
}
